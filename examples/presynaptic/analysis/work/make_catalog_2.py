...
catalog_rules = {
    r'^identifier': {r'ctrl_1': 'treated_2'},
    r'^treatment': {r'ctrl': 'treated'},
    r'^animal_nr': {r'ctrl 12': 'treated 3'},
    r'^sv_': {r'cell_tomo-4': 'cell_tomo-2'},
    r'^tethers_': {r'cell_tomo-4': 'cell_tomo-2'},
    r'^connectors_': {r'cell_tomo-4': 'cell_tomo-2'},
    r'^layers_': {r'cell_tomo-4': 'cell_tomo-2'},
    r'^cluster_': {r'cell_tomo-4': 'cell_tomo-2'}}
