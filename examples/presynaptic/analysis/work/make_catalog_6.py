...
catalog_rules = {
    r'^identifier': {r'ctrl_1': 'treated_5'},
    r'^treatment': {r'ctrl': 'treated'},
    r'^animal_nr': {r'ctrl 12': 'treated 4'},
    r'^sv_': {r'cell_tomo-4': 'cell_tomo-6'},
    r'^tethers_': {r'cell_tomo-4': 'cell_tomo-6'},
    r'^connectors_': {r'cell_tomo-4': 'cell_tomo-6'},
    r'^layers_': {r'cell_tomo-4': 'cell_tomo-6'},
    r'^cluster_': {r'cell_tomo-4': 'cell_tomo-6'}}
