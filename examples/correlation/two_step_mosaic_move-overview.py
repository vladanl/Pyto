...
involves three coordinate system:
  - LM: LM image
  - EM overview: (relatively) low magnification EM image  
...
# to be specified.
lm_markers_file = 'correlation_data_mosaic.dat'
...
overview_markers_rows = range(22, 26)
...
overview_detail_rows = range(18, 22)
...
results_file = 'two_step_mosaic-move-overview.dat'
